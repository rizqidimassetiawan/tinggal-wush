		...
		return $(this).each(function(){
			if($(this).is('input')&&!$(this).hasClass('picker-input')) {
				...
				var
					...
					picker_init_set = (input.data('init-set')===false) ? true : false,
					picker_lang = (input.data('lang')&&(input.data('lang') in i18n)) ? input.data('lang') : 'id',
